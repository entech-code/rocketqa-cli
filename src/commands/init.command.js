...
async function handleInitCommand() {
  console.log('🚀 Initializing new Pandatest project...\n');
  ...
  try {
    ...
    console.log('2. Install Playwright browsers: pandatest install');
    console.log('3. Run your tests with: pandatest test');
    console.log('4. List available steps with: pandatest steps');
  ...
  return new Promise((resolve) => {
    rl.question('📝 Enter project name: ', (answer) => {
      ...
      if (!answer || answer.trim() === '') {
        console.log('⚠️  Project name cannot be empty. Using default name "pandatest-project"');
        resolve('pandatest-project');
      } else {
